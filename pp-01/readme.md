...
1. Go to the TypeConnection game at http://www.typeconnection.com/. Play it until you arrive at
   ...
   1. http://www.typeconnection.com/step5/sp.php
...
3. Make a record of your paired typefaces here (Name and URL on Google Fonts):
   ...
   Typeface One:
     - Name: IBM Plex Sans Thai Looped, Source Sans Pro
     - URL: https://fonts.googleapis.com/css2?family=IBM+Plex+Sans+Thai+Looped:wght@200&family=Source+Sans+Pro:wght@200&display=swap
   Typeface Two:
